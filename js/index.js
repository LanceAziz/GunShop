        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarScroll">
                ...
                <div class="d-flex justify-content-center">
                    ...
                    <button class="btn skew rounded-0 btn-outline-primary fa-sm px-4">Sign In</button>
                    <button class="btn skew rounded-0 btn-outline-primary fa-sm px-4">Sign Up</button>
                </div>
            </div>
        </div>
    </nav>`;
